...
import { FaUserTie, FaFacebookF, FaTwitter, FaInstagram, FaLinkedinIn, FaApple, FaGooglePlay } from 'react-icons/fa'; // Added FaApple, FaGooglePlay
  ...
  return (
    <PageContainer fluid>
        ...
        <div className="hero-content">
          <div className="text-column">
            ...
            <div className="hero-buttons">
              <Button
                onClick={() => showCustomModal('Download for iOS!')}
                className="btn-primary-filled"
              >
                <FaApple /> Get on App Store
              </Button>
              <Button
                onClick={() => showCustomModal('Download for Android!')}
      ...
      <SecondaryHeroSection>
        ...
        <div className="hero-buttons">
          <Button
            onClick={() => showCustomModal('Start your journey as a chef!')}
      ...
      {/* Benefits Grid (Replaced "Value Grid" with clearer "Benefits") */}
      <BenefitGrid>
      ...
      <CtaSection>
        ...
        <div className="cta-buttons">
          <Button variant="light" className="btn-light-styled">
            Sign Up Now!
          </Button>
