...
import { 
  ...
  Eye, InfoCircle, ShieldCheck, Plus, Dash 
...
const LiquorProductsGrid = () => {
  ...
  const [products, setProducts] = useState([
    {
      ...
      vendor: {
        ...
        rating: 4.9,
        profilePicture: "/images/vendor1.jpg",
    ...
    },
    {
      ...
      vendor: {
        ...
        rating: 4.7,
        profilePicture: "/images/vendor2.jpg",
    ...
    },
    {
      ...
      vendor: {
        ...
        rating: 4.8,
        profilePicture: "/images/vendor3.jpg",
    ...
    },
    {
      ...
      vendor: {
        ...
        rating: 4.6,
        profilePicture: "/images/vendor4.jpg",
    ...
    },
    {
      ...
      photoUrls: [
        "/images/champagne1.jpg",
        "/images/champagne2.jpg"
      ],
      vendor: {
        id: 105,
        user: {
        ...
        rating: 5.0,
        profilePicture: "/images/vendor5.jpg",
    ...
    },
    {
      ...
      vendor: {
        ...
        rating: 4.5,
        profilePicture: "/images/vendor6.jpg",
  ...
  const handleLike = (id) => {
    setProducts(products.map(product => 
      product.id === id 
        ? {...product, likes: product.likes + (product.liked ? -1 : 1), liked: !product.liked} 
        : product
    ));
  };
        ...
        {selectedProduct && (
          <>
            ...
            <Modal.Body>
              <Row>
                <Col md={6}>
                  <div className="position-relative" style={{ height: '400px', overflow: 'hidden', borderRadius: '12px' }}>
                    <Carousel 
                      interval={null} 
                ...
                <Col md={6}>
                  <div className="d-flex justify-content-between align-items-center mb-3">
                    <h3 className="fw-bold mb-0" style={{ color: theme.dark }}>
                      {selectedProduct.title}
                    </h3>
                    <div className="d-flex align-items-center">
